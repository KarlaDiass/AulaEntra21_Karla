...
no __init__, todos os dados de cadastro entra no banco de dados
    ...
    def __init__(self, nome: str, marca: str, modelo: str, cor: str, placa: str,
        ...
        self.dados = (self.nome, self.marca, self.modelo, self.ano, self.valor, self.cor, self.placa, self.proprietario, 
            self.num_portas, self.km_rodado, self.qtd_passageiros, self.motor, self.combustivel, self.meio_locomocao)
