...
#Professor, eu preferi mudar um pouco o exercício, espero que não tenha problema :)
#Nas atividade anteriores eu encadeei os "if's" dentro dos "else's", pois não tinha conhecimento
#do "elif", mas não quis mudar as anteriores porque acho que foi um conhecimento novo
#que vai otimizar espaço no código, e eu gosto de ver a minha evolução como programadora
